...
import type { Case, Dataset, Justice, Meta, PortraitEntry, VoteRec } from '../types'
...
export function loadDataset(): Promise<Dataset> {
  if (!datasetPromise) {
    datasetPromise = Promise.all([
      ...
      // Optional: generated by fetch_portraits.py. The site works without it.
      fetchJson<Record<string, PortraitEntry>>('portraits.json').catch(
        () => ({}) as Record<string, PortraitEntry>,
      ),
    ]).then(([cases, votes, justices, meta, portraits]) => {
